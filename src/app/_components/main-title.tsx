...
export function MainTitle(){
  return (
    <div className='relative flex h-fit w-full flex-col items-center justify-between'>
      <div className='absolute -z-50 h-64 w-64 bg-[conic-gradient(transparent, rgb(0,0,0))] opacity-15 blur-2x1 dark:bg-[conic-gradient(transparent, rgb(255,255,255))] md:left-36'/>

      <div className='className="absolute left-1/2 top-1/2 w-max -translate-x-1/2 -translate-y-1/2 opacity-10 dark:opacity-5 md:hidden'>
        <Image
          src={deconstructedRobotBroLight}
          alt='Deconstructed Robot Bro Light'
          className='w-96 object-cover dark:hidden'
        />
        <Image
          src={deconstructedRobotBroDark}
          alt='Deconstructed Robot Bro Dark'
