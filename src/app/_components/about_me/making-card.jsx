...
type Repo = {
  name: string // 'gabrieldnsilva-portfolio'
  full_name: string //'gabrieldnsilva/gabrieldnsilva-portfolio'
  html_url: string // 'https://github.com/gabrieldnsilva/gabrieldnsilva-portfolio'
  description: string //'🌐 Personal momepage to show my skills and projects.'
  created_at: string //'2024-10-19T20:28:28Z'
...
export async function MakingCard() {
  const repoData = await getRepoData({ user: 'gabrieldnsilva', repo: 'gabrieldnsilva-portfolio' })
  return (
